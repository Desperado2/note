...
//"---"被和谐了 。。。。。。
    ...
    var W = (function () {
        var C = M("top").getElementsByTagName("SPAN")[0];
        var X = M("top").getElementsByTagName("SPAN")[1];
        var G = M("top").getElementsByTagName("SPAN")[2];
        var c = M("top").getElementsByTagName("SPAN")[3];
        ...
        function a(g) {
           ...
           // d(g.solarYear, g.solarMonth);
            C.innerHTML =new Date().getFullYear();
            X.innerHTML =new Date().getMonth()+1;
            G.innerHTML = g.ganzhiYear;
            c.innerHTML = g.shengxiao;
            Y.onclick = Z;
            Y.style.visibility = "hidden"
